...
public class Mario extends Image {
    TextureRegion stand;
    Animation walk, jump;
    ...
    public Mario() {
        ...
        Texture marioTexture = new Texture("little_mario.png");
        TextureRegion[][] grid = TextureRegion.split(marioTexture, (int) width, (int) height);

        stand = grid[0][0];
        jump = new Animation(0.15f, grid[0][9], grid[0][10], grid[0][11], grid[0][12], grid[0][13]);
